            ...
            <div class="container" style="text-align: center;align-items: center;margin:0;padding:0; height:100%; width: 100%;">
                ...
                <div class="col">
                    <div class="progress" style="background:var(--background);">
                        <div class="progress-bar progress-bar progress-bar-animated" role="progressbar" style="width: ${pokemo_info.stats[0]}%" aria-valuenow="${pokemo_info.stats[0]}" aria-valuemin="0" aria-valuemax="255">Spd ${pokemo_info.stats[0]}</div>
                    </div>
                    <div class="progress" style="background:var(--background);">
                        <div class="progress-bar progress-bar progress-bar-animated bg-success" role="progressbar" style="width: ${pokemo_info.stats[1]}%" aria-valuenow="${pokemo_info.stats[1]}" aria-valuemin="0" aria-valuemax="255">Sp. Def ${pokemo_info.stats[1]}</div>
                    </div>
                    <div class="progress" style="background:var(--background);">
                        <div class="progress-bar progress-bar progress-bar-animated bg-info" role="progressbar" style="width: ${pokemo_info.stats[2]}%" aria-valuenow="${pokemo_info.stats[2]}" aria-valuemin="0" aria-valuemax="255">Sp. Atk. ${pokemo_info.stats[2]}</div>
                    </div>
                    <div class="progress" style="background:var(--background);">
                        <div class="progress-bar progress-bar progress-bar-animated bg-warning" role="progressbar" style="width: ${pokemo_info.stats[3]}%" aria-valuenow="${pokemo_info.stats[3]}" aria-valuemin="0" aria-valuemax="255">Def. ${pokemo_info.stats[3]}</div>
                    </div>
                    <div class="progress" style="background:var(--background);">
                        <div class="progress-bar progress-bar progress-bar-animated" role="progressbar" style="width: ${pokemo_info.stats[4]}%" aria-valuenow="${pokemo_info.stats[4]}" aria-valuemin="0" aria-valuemax="255">Atk. ${pokemo_info.stats[4]}</div>
                    </div>
                    <div class="progress" style="background:var(--background);">
                        <div class="progress-bar progress-bar progress-bar-animated bg-danger" role="progressbar" style="width: ${pokemo_info.stats[5]}%" aria-valuenow="${pokemo_info.stats[5]}" aria-valuemin="0" aria-valuemax="255">HP ${pokemo_info.stats[5]}</div>
                    </div>
                </div>
